...
#         forte_count = self.task.get_current_char().count_rectangle_forte()
#         self.task.sleep(1)
...
#         forte_count = self.task.get_current_char().count_rectangle_forte()
#         self.task.sleep(1)
#         self.assertGreater(forte_count, 3)
#
...
#         forte_count = self.task.get_current_char().count_rectangle_forte()
#         self.task.sleep(1)
#         self.assertGreater(forte_count, 30)
#
...
#         self.assertGreater(forte_count, 13)
#
#     def test_forte9(self):
#         self.task.do_reset_to_false()
#         self.set_image('tests/images/treasure.png')
#         self.task.load_chars()
#         forte_count = self.task.get_current_char().count_rectangle_forte()
#         self.task.sleep(1)
#         self.assertGreater(forte_count, 0)
#
#     def test_forte10(self):
#         self.task.do_reset_to_false()
...
#         self.assertGreater(forte_count, 0)
#
#     def test_forte11(self):
#         self.task.do_reset_to_false()
#         self.set_image('tests/images/echo2.png')
#         self.task.load_chars()
#         forte_count = self.task.get_current_char().count_rectangle_forte()
#         self.task.sleep(1)
#         self.assertGreater(forte_count, 11)
#
#
