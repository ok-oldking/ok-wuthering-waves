...
class BaseCombatTask(CombatCheck):
    ...
    def _is_map_open_for_recovery(self):
        ...
        优先检测 map_setting_gear / map_search（需后续补充特征模板到 coco_annotations.json），
        当前这两个特征未注册，feature_exists 返回 False 会自动回退到 map_my_location 和 waypoint 检测。
        """
        # TODO: 补充 map_setting_gear / map_search 的模板图片到 assets 和 coco_annotations.json
