...
from src.task.BaseCombatTask import BaseCombatTask, NotInCombatException, CharDeadException, CombatAbortedAfterRevive
    ...
    def run(self):
        ...
        while self.in_combat():
            ...
            try:
                ...
                self.log_info(f'Death recovery completed, exiting auto combat')
                break
